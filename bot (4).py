...
# data, tickets, economy, and giveaways survive a bot restart. Purely
# session-scoped trackers (chat/VC stats, anti-spam/raid/nuke windows,
# live temp-VC ownership) are intentionally left in-memory since they're
# meant to reset each run.
DATA_DIR = "data"
...
TICKET_TYPES = {
    ...
    "court":     ("⚖️ Court Application",  "Apply to join the court/trial team",   discord.Color.dark_gold()),
}
...
class TicketTypeSelect(discord.ui.Select):
    def __init__(self):
        options = [
            ...
            discord.SelectOption(
                label="Court Application",
                value="court",
                emoji="⚖️",
                description="Apply to join the court/trial team"
            ),
        ]
        super().__init__(
    ...
    def admin_embed(self, guild: discord.Guild):
        ...
        embed.add_field(
            ...
            value=(
                ...
                "Row 3: 🔐 Lock  🔓 Unlock\n"
                "**Categories (9):** General • Report • Appeal • Form a Alliance • Bug • Unban • Staff App • Division App • Court App"
            ),
            inline=False
        )
        embed.add_field(
...
async def sendtickets(ctx):
    ...
    embed.add_field(
        ...
        value=(
            ...
            "⚖️ **Court Application** — Apply to join the court/trial team"
        ),
        inline=False
    )
    embed.add_field(
